...
*CatalogApi* | [**catalog_get_entry**](docs/CatalogApi.md#catalog_get_entry) | **GET** /catalog/entry/{owner}/{repo}/{ref} | Catalog entry
*CatalogApi* | [**catalog_get_metadata**](docs/CatalogApi.md#catalog_get_metadata) | **GET** /catalog/entry/{owner}/{repo}/{ref}/metadata | Catalog entry metadata (manifest.yaml in JSON format)
*CatalogApi* | [**catalog_list_languages**](docs/CatalogApi.md#catalog_list_languages) | **GET** /catalog/owners | Catalog list owners
*CatalogApi* | [**catalog_list_subjects**](docs/CatalogApi.md#catalog_list_subjects) | **GET** /catalog/subjects | Catalog list subjects
*CatalogApi* | [**catalog_search**](docs/CatalogApi.md#catalog_search) | **GET** /catalog/search | Catalog search
*CatalogApi* | [**catalog_search_owner**](docs/CatalogApi.md#catalog_search_owner) | **GET** /catalog/search/{owner} | Catalog search by owner
*CatalogApi* | [**catalog_search_repo**](docs/CatalogApi.md#catalog_search_repo) | **GET** /catalog/search/{owner}/{repo} | Catalog search by repo
...
*RepositoryApi* | [**repo_create_git_ref**](docs/RepositoryApi.md#repo_create_git_ref) | **POST** /repos/{owner}/{repo}/git/refs | Create a reference
...
*RepositoryApi* | [**repo_delete_git_ref**](docs/RepositoryApi.md#repo_delete_git_ref) | **DELETE** /repos/{owner}/{repo}/git/refs/{ref} | Delete a reference
...
*RepositoryApi* | [**repo_update_git_ref**](docs/RepositoryApi.md#repo_update_git_ref) | **PATCH** /repos/{owner}/{repo}/git/refs/{ref} | Update a reference
...
## Documentation For Models
 ...
 - [CatalogSearchResults](docs/CatalogSearchResults.md)
 ...
 - [CreateGitRefOption](docs/CreateGitRefOption.md)
 ...
 - [UpdateGitRefOption](docs/UpdateGitRefOption.md)
 - [User](docs/User.md)
