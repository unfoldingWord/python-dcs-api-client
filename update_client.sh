...
curl -H 'Content-type: application/json' -X POST -d "{\"options\": {\"packageName\": \"dcs_api_client\", \"projectName\": \"dcs-api-client\", \"packageVersion\": \"$version\", \"packageUrl\": \"https://github.com/unfoldingWord/python-dcs-api-client\"}, \"swaggerUrl\": \"https://git.door43.org/swagger.v1.json\"}" https://generator.swagger.io/api/gen/clients/python | curl $(jq -r '.link') -o client.zip
