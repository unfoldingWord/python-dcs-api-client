...
**repo_languages** | **list[str]** | DCS Customizations ***/ Repo languages | [optional] 
**repo_subjects** | **list[str]** | Repo subjects | [optional] 
**restricted** | **bool** | END DCS Customizations ***/ Is user restricted | [optional] 
