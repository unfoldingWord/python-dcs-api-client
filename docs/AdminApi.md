...
body = dcs_api_client.RenameUserOption() # RenameUserOption | 
...
# **admin_search_users**
> list[User] admin_search_users(source_id=source_id, login_name=login_name, lang=lang, page=page, limit=limit)
...
try:
    # Search users according filter conditions
    api_response = api_instance.admin_search_users(source_id=source_id, login_name=login_name, lang=lang, page=page, limit=limit)
    pprint(api_response)
except ApiException as e:
