...
body = dcs_api_client.EditIssueOption() # EditIssueOption |  (optional)
...
body = dcs_api_client.EditDeadlineOption() # EditDeadlineOption |  (optional)
...
body = dcs_api_client.EditMilestoneOption() # EditMilestoneOption |  (optional)
