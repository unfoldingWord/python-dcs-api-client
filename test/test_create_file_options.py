...
from dcs_api_client.models.create_file_options import CreateFileOptions  # noqa: E501
...
class TestCreateFileOptions(unittest.TestCase):
    ...
    def testCreateFileOptions(self):
        ...
        # model = dcs_api_client.models.create_file_options.CreateFileOptions()  # noqa: E501
        pass
