...
class IssueApi(object):
    ...
    def issue_list_issues(self, owner, repo, **kwargs):  # noqa: E501
        ...
        :param str created_by: filter (issues / pulls) created to
        :param str assigned_by: filter (issues / pulls) assigned to
        :param str mentioned_by: filter (issues / pulls) mentioning to
        :param int page: page number of results to return (1-based)
        :param int limit: page size of results
        :return: list[Issue]
                 If the method is called asynchronously,
    ...
    def issue_search_issues_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['state', 'labels', 'milestones', 'q', 'priority_repo_id', 'type', 'since', 'before', 'assigned', 'created', 'mentioned', 'review_requested', 'page', 'limit']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
