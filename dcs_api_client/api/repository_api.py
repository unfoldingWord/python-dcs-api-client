...
class RepositoryApi(object):
    ...
    def repo_search(self, **kwargs):  # noqa: E501
        ...
        :param str repo: name of the repo. Multiple repo's are ORed.
        :param str owner: owner of the repo. Multiple owner's are ORed.
        :param str lang: If the repo is a resource of the given language(s), the repo will be in the results. Multiple lang's are ORed.
        :param str subject: resource subject. Multiple subject's are ORed.
        :param str book: book (project id) that exist in a resource. If the resource contains the the book, its repository will be included in the results. Multiple book's are ORed.
        :param bool include_metadata: if false, q value will only be searched for in the repo name, owner, description and title and subject; otherwise search all values of the manifest file. (defaults to false)
    ...
    def repo_search_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['q', 'topic', 'include_desc', 'uid', 'priority_owner_id', 'team_id', 'starred_by', 'private', 'is_private', 'template', 'archived', 'mode', 'exclusive', 'repo', 'owner', 'lang', 'subject', 'book', 'include_metadata', 'sort', 'order', 'page', 'limit']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
