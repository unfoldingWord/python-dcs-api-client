...
class RepositoryApi(object):
    ...
    def repo_create_git_ref(self, owner, repo, **kwargs):  # noqa: E501
        """Create a reference  # noqa: E501

        Creates a reference for your repository. You are unable to create new references for empty repositories, even if the commit SHA-1 hash used exists. Empty repositories are repositories without branches.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_create_git_ref(owner, repo, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.repo_create_git_ref_with_http_info(owner, repo, **kwargs)  # noqa: E501
        else:
            (data) = self.repo_create_git_ref_with_http_info(owner, repo, **kwargs)  # noqa: E501
            return data

    def repo_create_git_ref_with_http_info(self, owner, repo, **kwargs):  # noqa: E501
        """Create a reference  # noqa: E501

        Creates a reference for your repository. You are unable to create new references for empty repositories, even if the commit SHA-1 hash used exists. Empty repositories are repositories without branches.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_create_git_ref_with_http_info(owner, repo, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method repo_create_git_ref" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'owner' is set
        if self.api_client.client_side_validation and ('owner' not in params or
                                                       params['owner'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `owner` when calling `repo_create_git_ref`")  # noqa: E501
        # verify the required parameter 'repo' is set
        if self.api_client.client_side_validation and ('repo' not in params or
                                                       params['repo'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `repo` when calling `repo_create_git_ref`")  # noqa: E501
    ...
    def repo_delete_git_ref(self, owner, repo, ref, **kwargs):  # noqa: E501
        """Delete a reference  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_delete_git_ref(owner, repo, ref, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str owner: owner of the repo (required)
        :param str repo: name of the repo (required)
        :param str ref: name of the ref to be deleted (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.repo_delete_git_ref_with_http_info(owner, repo, ref, **kwargs)  # noqa: E501
        else:
            (data) = self.repo_delete_git_ref_with_http_info(owner, repo, ref, **kwargs)  # noqa: E501
            return data

    def repo_delete_git_ref_with_http_info(self, owner, repo, ref, **kwargs):  # noqa: E501
        """Delete a reference  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_delete_git_ref_with_http_info(owner, repo, ref, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method repo_delete_git_ref" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'owner' is set
        if self.api_client.client_side_validation and ('owner' not in params or
                                                       params['owner'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `owner` when calling `repo_delete_git_ref`")  # noqa: E501
        # verify the required parameter 'repo' is set
        if self.api_client.client_side_validation and ('repo' not in params or
                                                       params['repo'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `repo` when calling `repo_delete_git_ref`")  # noqa: E501
        # verify the required parameter 'ref' is set
        if self.api_client.client_side_validation and ('ref' not in params or
                                                       params['ref'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `ref` when calling `repo_delete_git_ref`")  # noqa: E501
    ...
    def repo_search(self, **kwargs):  # noqa: E501
        ...
        :param bool include_desc: include search of keyword within repository description (defaults to false)
        ...
        :param str repo: name of the repo. Multiple repos are ORed.
        :param str owner: owner of the repo. Multiple owners are ORed.
        :param str lang: If the repo is a resource of the given language(s), the repo will be in the results. Multiple langs are ORed.
        :param str subject: resource subject. Multiple subjects are ORed.
        ...
        :param str book: book (project id) that exist in a resource. If the resource contains the the book, its repository will be included in the results. Multiple books are ORed.
        :param str metadata_type: return repos only with metadata of this type (e.g. rc, tc, ts, sb)
    ...
    def repo_search_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['q', 'topic', 'include_desc', 'uid', 'priority_owner_id', 'team_id', 'starred_by', 'private', 'is_private', 'template', 'archived', 'mode', 'exclusive', 'repo', 'owner', 'lang', 'subject', 'resource', 'format', 'book', 'metadata_type', 'metadata_version', 'sort', 'order', 'page', 'limit']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def repo_update_git_ref(self, owner, repo, ref, **kwargs):  # noqa: E501
        """Update a reference  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_update_git_ref(owner, repo, ref, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str owner: owner of the repo (required)
        :param str repo: name of the repo (required)
        :param str ref: name of the ref to update (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.repo_update_git_ref_with_http_info(owner, repo, ref, **kwargs)  # noqa: E501
        else:
            (data) = self.repo_update_git_ref_with_http_info(owner, repo, ref, **kwargs)  # noqa: E501
            return data

    def repo_update_git_ref_with_http_info(self, owner, repo, ref, **kwargs):  # noqa: E501
        """Update a reference  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_update_git_ref_with_http_info(owner, repo, ref, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['owner', 'repo', 'ref', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method repo_update_git_ref" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'owner' is set
        if self.api_client.client_side_validation and ('owner' not in params or
                                                       params['owner'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `owner` when calling `repo_update_git_ref`")  # noqa: E501
        # verify the required parameter 'repo' is set
        if self.api_client.client_side_validation and ('repo' not in params or
                                                       params['repo'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `repo` when calling `repo_update_git_ref`")  # noqa: E501
        # verify the required parameter 'ref' is set
        if self.api_client.client_side_validation and ('ref' not in params or
                                                       params['ref'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `ref` when calling `repo_update_git_ref`")  # noqa: E501
