...
class UserApi(object):
    ...
    def user_search(self, **kwargs):  # noqa: E501
        ...
        :param str lang: If the user has one or more repos with the given language(s), the org will be in the results. Multiple lang's are ORed.
        :param str subject: If the user has one or more repos with the given subject(s), the org will be in the results. Multiple subjects are ORed.
        :param str metadata_type: If the user has one or more repos with the given metadata type(s), the org will be in the results. Multiple metadata types are ORed.
        :param int page: page number of results to return (1-based)
        :param int limit: page size of results
    ...
    def user_search_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['q', 'uid', 'lang', 'subject', 'metadata_type', 'page', 'limit']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
