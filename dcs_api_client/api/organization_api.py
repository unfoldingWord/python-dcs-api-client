...
class OrganizationApi(object):
    ...
    def org_get_all(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str lang: If the org has one or more repos with the given language(s), the org will be in the results. Multiple lang's are ORed.
    ...
    def org_get_all_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['lang', 'subject', 'metadata_type', 'page', 'limit']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
