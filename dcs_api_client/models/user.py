...
class User(object):
    ...
    def __init__(self, active=None, avatar_url=None, created=None, description=None, email=None, followers_count=None, following_count=None, full_name=None, id=None, is_admin=None, language=None, last_login=None, location=None, login=None, login_name='empty', prohibit_login=None, repo_languages=None, repo_metadata_types=None, repo_subjects=None, restricted=None, starred_repos_count=None, visibility=None, website=None, _configuration=None):  # noqa: E501
    ...
    def repo_metadata_types(self):
        """Gets the repo_metadata_types of this User.  # noqa: E501

        Repo metadata types  # noqa: E501

        :return: The repo_metadata_types of this User.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def repo_metadata_types(self, repo_metadata_types):
        """Sets the repo_metadata_types of this User.

        Repo metadata types  # noqa: E501

        :param repo_metadata_types: The repo_metadata_types of this User.  # noqa: E501
        :type: list[str]
        """
